using Adform.Todo.Service.GraphQlSupport.Model;
using Adform.Todo.Service.GraphQlSupport.Mutation;
using Adform.Todo.Service.GraphQlSupport.Query;
using Adform.Todo.Service.Middleware;
using Adform.Todo.Service.SwaggerSupport;
            ...
            .AddJwtBearer(options =>
            {
                ...
                options.TokenValidationParameters = new TokenValidationParameters()
                {
                    ...
                    RequireExpirationTime = false
                                ...
                                //options.Authority = Configuration.GetValue<string>("Issuer");
                //options.SaveToken = true;
                //options.RequireHttpsMetadata = false;
                //options.TokenValidationParameters = new TokenValidationParameters()
                //{
